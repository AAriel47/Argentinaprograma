...
public double importe;
	...
	public Articulos(String articulo, int codigo, double precio, double descuento) {
	...
	public Articulos(String articulo, int codigo, double precio, double descuento, double importe) {
		// TODO Auto-generated constructor stub
		this.codigo=codigo;
		this.articulo=articulo;
		this.precio=precio;
